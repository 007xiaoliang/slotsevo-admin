...
var files = []model.ExaFileUploadAndDownload{
	{global.SlotsModel{ID: 1, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "10.png", "http://qmplusimg.henrongyi.top/Slotslogo.png", "png", "158787308910.png"},
	{global.SlotsModel{ID: 2, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "logo.png", "http://qmplusimg.henrongyi.top/1576554439myAvatar.png", "png", "1587973709logo.png"},
}
