<template>
  <div>
    <el-row :gutter="10">
      <el-col :span="12">
        <el-card>
          <div slot="header">slotsevo-web</div>
          <div>
            <el-row>
              <el-col :span="8" :offset="8">
                <a href="https://github.com/flipped-aurora/slotsevo-web">
                  <img
            ...
            <el-row :gutter="10">
              <el-col :span="8">
                <a href="https://github.com/flipped-aurora/slotsevo-web">
                  <img
                    class="dom-center"
                    src="https://img.shields.io/github/watchers/flipped-aurora/slotsevo-web.svg?label=Watch"
                    alt=""
                  />
                </a>
              </el-col>
              <el-col :span="8">
                <a href="https://github.com/flipped-aurora/slotsevo-web">
                  <img
                    class="dom-center"
                    src="https://img.shields.io/github/stars/flipped-aurora/slotsevo-web.svg?style=social"
                    alt=""/></a
              ></el-col>
              <el-col :span="8">
                <a href="https://github.com/flipped-aurora/slotsevo-web">
                  <img
                    class="dom-center"
                    src="https://img.shields.io/github/forks/flipped-aurora/slotsevo-web.svg?label=Fork"
                    alt=""/></a
              ></el-col>
            </el-row>
          </div>
